...
import com.euroscript.pdfform.FormField;
import com.euroscript.pdfform.PdfFormExtractor;
...
public class PdfFormReader extends DfSingleDocbaseModule implements IDfModule, IPdfFormReader {
     ...
     * Logger.
     */
    private static final Logger LOG = Logger.getLogger(com.euroscript.modules.PdfFormReader.class.getName());
